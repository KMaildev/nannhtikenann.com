        ...
        <div class="row">
            <div class="col-12">
                <div class="section-title">
                    ...
                    <br>
                    <span class="wow fadeInDown" data-wow-delay=".2s">
                        <a href="<?php echo site_url('jobseeker/index'); ?>" style="color: white;">
                            Upload Your Resume
                        </a>
                    </span>
                </div>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-4 col-12">
                <div class="process-item">
                    ...
                    <h4>Search the Job</h4>
                    <p>
                        Speed up your job search! Search or get recommendations for jobs that match what you're looking for.
                    </p>
                </div>
            </div>
            <div class="col-lg-4 col-md-4 col-12">
                <div class="process-item">
                    ...
                    <h4>Apply Your Job</h4>
                    <p>
                        Create a profile,get it and immediately get noticed by the right recruiters....
                    </p>
                </div>
            </div>
            <div class="col-lg-4 col-md-4 col-12">
                <div class="process-item">
                    ...
                    <p>
                        Get access to career guidance and advice via the "Career Center" and standout from the rest.
                    </p>
                </div>
            </div>
        </div>
